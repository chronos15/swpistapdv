...
abstract class FlutterFlowTheme {
  ...
  late Color customPrimary;
  late Color cardAlter;
  late Color border;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0064ED);
  late Color secondary = const Color(0xFF0D8CFF);
  ...
  late Color customPrimary = Color(0xFFFF5D00);
  late Color cardAlter = Color(0xFF283242);
  late Color border = Color(0x001B0CB9);
  late Color cardSelection = Color(0xFFC8B2FF);
  late Color cardTotalizacao = Color(0xFF1B1D27);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color customPrimary = Color(0xFFFF5D00);
  late Color cardAlter = Color(0xFFFFFFFF);
  late Color border = Color(0x42797979);
  late Color cardSelection = Color(0xFF621A6D);
  late Color cardTotalizacao = Color(0xFFE8E8E8);
}
