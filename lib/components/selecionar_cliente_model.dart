...
import 'selecionar_cliente_widget.dart' show SelecionarClienteWidget;
import 'package:flutter/material.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';

class SelecionarClienteModel extends FlutterFlowModel<SelecionarClienteWidget> {
  ///  Local state fields for this component.

  ClienteListaDataTypeStruct? clienteSelectedPage;
  void updateClienteSelectedPageStruct(
      Function(ClienteListaDataTypeStruct) updateFn) {
    updateFn(clienteSelectedPage ??= ClienteListaDataTypeStruct());
  }
