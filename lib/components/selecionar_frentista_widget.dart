...
class SelecionarFrentistaWidget extends StatefulWidget {
  const SelecionarFrentistaWidget({super.key});

  @override
  State<SelecionarFrentistaWidget> createState() =>
...
class _SelecionarFrentistaWidgetState extends State<SelecionarFrentistaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelecionarFrentistaModel());
