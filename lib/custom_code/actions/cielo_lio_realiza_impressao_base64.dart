...
Future<bool> cieloLioRealizaImpressaoBase64(
    BuildContext context, String? pdfBase64) async {
  if (pdfBase64 == null || pdfBase64.isEmpty) {
    print("Erro: Base64 do PDF não fornecido.");
    return false;
  }
  ...
  try {
    // Decodifica o PDF em base64 para bytes
    final pdfBytes = base64Decode(pdfBase64);

    // Abre o documento PDF diretamente dos bytes
    ...
    final pngBytes = img.encodeJpg(rawImage, quality: 80);

    // Caminho para salvar a imagem renderizada
    ...
    // Cria a requisição de impressão Lio
    final printRequest = {
