...
Future<bool> cieloLioRealizaEstorno(
  String? jsonValue,
  ...
  if (!await canLaunchUrl(Uri.parse("lio://payment-reversal"))) {
  ...
  final jsonBase64 = base64Encode(utf8.encode(jsonValue));
  final url =
      "lio://payment-reversal?request=$jsonBase64&urlCallback=order://payment";
