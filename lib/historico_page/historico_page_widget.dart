...
import '/components/opcao_pedido_widget.dart';
          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            valueOrDefault<String>(
                              FFAppState().HistoricoVendas.length.toString(),
                              '0',
                            ),
                            style: FlutterFlowTheme.of(context)
                                .headlineSmall
              ...
              Expanded(
                child: Builder(
                  builder: (context) {
                    final resultHistorico = functions
                            .filtraVendaHistorico(
                                FFAppState()
                                    .HistoricoVendas
                                    .unique((e) => e.chaveUnextern)
                                    .toList(),
                                _model.textController.text,
                                _model.actReturnDT?.start,
                                _model.actReturnDT?.end)
                            ?.sortedList(keyOf: (e) => e.idCodigo, desc: true)
                            .toList() ??
                        [];
                    if (resultHistorico.isEmpty) {
                      return Center(
                        child: Container(
                          height: 250.0,
                          child: m_s_framework_flutter_p5iajh
                            ...
                            sTitulo: 'Lista Vazia',
                            sTexto: 'Verifique seus filtros e tente novamente!',
                            bIsAction: false,
                            vSizeTitulo: 16.0,
                            vSizeTexto: 14.0,
                            corTitulo:
                    ...
                    return ListView.separated(
                      ...
                      itemCount: resultHistorico.length,
                      separatorBuilder: (_, __) => SizedBox(height: 5.0),
                      itemBuilder: (context, resultHistoricoIndex) {
                        final resultHistoricoItem =
                            resultHistorico[resultHistoricoIndex];
                        return Container(
                          decoration: BoxDecoration(
                            color: FlutterFlowTheme.of(context)
                                .secondaryBackground,
                                  ...
                                  child: ExpandablePanel(
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        '${resultHistoricoItem.idCliente.toString()} - ${resultHistoricoItem.nomeCliente}',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyLarge
                                                      ...
                                                      Text(
                                                        'ID: ${resultHistoricoItem.idCodigo.toString()} - ${valueOrDefault<String>(
                                                          dateTimeFormat(
                                                            "dd/MM/yyyy",
                                                            functions.stringToDateYMD(
                                                                resultHistoricoItem
                                                                    .datavenda),
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${resultHistoricoItem.numeroitens.toString()} Itens',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                    ...
                                    expanded: Column(
                                      ...
                                      children: [
                                        ...
                                        Builder(
                                          builder: (context) {
                                            final produtos = resultHistoricoItem
                                                .vendaitemRem
                                                .toList();
                                      ...
                                      builder: (context) {
                                        return GestureDetector(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(
                                              height: 340.0,
                                              child: OpcaoPedidoWidget(
                                                dtVenda: resultHistoricoItem,
                                              ),
                                            ),
                                          ),
                                        );
