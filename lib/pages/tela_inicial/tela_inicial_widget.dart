            ...
            if (details.delta.dy >= 0.0) {
              await showDialog(
                ...
                builder: (alertDialogContext) {
                  return AlertDialog(
                    title: Text('test'),
                    content: Text('Iniciou rolagem colunm'),
                    actions: [
                      TextButton(
              ...
              await showDialog(
                ...
                builder: (alertDialogContext) {
                  return AlertDialog(
                    title: Text('test'),
                    content: Text('Parou rolagem colunm'),
                    actions: [
                      TextButton(
                        onPressed: () => Navigator.pop(alertDialogContext),
                        child: Text('Ok'),
                ...
                child: AnimatedContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          ...
                          children: [
                              ...
                              onPressed: () async {
                                ...
                                if (_model.vFiltrosReturn != null) {
                                  _model.combustivelSelected = _model
                                      .vFiltrosReturn?.combustivelSelected;
                                  safeSetState(() {});
                                  FFAppState().aFiltros =
                                      _model.vFiltrosReturn!;
                                  safeSetState(() {});
                                  await Future.wait([
                                    Future(() async {
                                      safeSetState(() => _model
                            ...
                            if ((_model.idBicoSelected! > 0) &&
                                (_model.combustivelSelected?.idProduto != 0))
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 5.0, 0.0),
                                        ...
                                        functions.dataTimeToTimeStamp(
                                            m_s_framework_flutter_p5iajh_functions
                                                .dateNullFormate(FFAppState()
                                                    .aFiltros
                                                    .dateInitial),
                                            FFAppState().aFiltros.dateFinal),
                                        valueOrDefault<int>(
                                          _model.combustivelSelected?.idProduto,
                                          0,
                                        ),
                                        FFAppState().aFiltros.bico.idBico, () {
                                      if (FFAppState().aFiltros.tPRegistro ==
                                          TPRegistro.Diversos) {
                                        return 0;
                                      } else if (FFAppState()
                                              .aFiltros
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            if (FFAppState()
                                                ...
                                                .toList()
                                                .isNotEmpty) {
                                              FFAppState().removeFromAbastecimentosSelecionados(
                                                  FFAppState()
                                                      .AbastecimentosSelecionados
                                                      .where((e) =>
                                                          e.codAbastecimento ==
                                                                  ...
                                                                  Text(
                                                                    valueOrDefault<
                                                                      ...
                                                                      dateTimeFormat(
                                                                        "dd/MM/yyyy  • HH:mm",
                                                                        m_s_framework_flutter_p5iajh_functions
                                                                            .dateNullFormate(functions.dataHoraJsonToDate(valueOrDefault<String>(
                                                                          ultimosAbastecimentoItem
                                                                              .datahora,
                                                                          '--',
                                                                        ))),
                      ...
                      if ((FFAppState().AbastecimentosSelecionados.length <=
                              0) &&
                          FFAppState().AsConnectPersisted)
                        Row(
                          mainAxisSize: MainAxisSize.max,
