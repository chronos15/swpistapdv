          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(12.0, 60.0, 12.0, 12.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(HistoricoPageWidget.routeName);
                              },
                              child: Material(
                                color: Colors.transparent,
                                child: ListTile(
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                ...
                                context
                                    .pushNamed(ListaClientesWidget.routeName);
                              },
                              child: Material(
                                color: Colors.transparent,
                                child: ListTile(
                                    ...
                                    onPressed: () async {
                                      await showModalBottomSheet(
                                        ...
                                        builder: (context) {
                                          ...
                                          () => _model.vFiltrosReturn = value));

                                      if (_model.vFiltrosReturn != null) {
                                        _model.aFiltros = _model.vFiltrosReturn;
                                ...
                                child: Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final staggeredViewBicosResponse =
                                          snapshot.data!;

                                      return Builder(
                                        builder: (context) {
                                          final bicos = BicosCall.bicos(
                                                staggeredViewBicosResponse
                                                    .jsonBody,
                                              )?.toList() ??
                                              [];
                                          if (bicos.isEmpty) {
                                  ...
                                  child: PagedListView<ApiPagingParams,
                                    ...
                                    pagingController:
                                      ...
                                      (nextPageMarker) =>
                                        ...
                                        demmand: 30,
                                        skip:
                                            nextPageMarker.nextPageNumber * 30,
                                        orderby: 'DATAHORA desc',
                                        filtro: functions
                                            .addFilterAbastecimento(
                                                ...
                                                _model.aFiltros?.bico.idBico,
                                                () {
                                          if (functions.enumStringTPToEnum(
                                                  _model.choiceChipsValue) ==
                                              TPRegistro.Diversos) {
                                            return 0;
                                          } else if (functions
                                                  .enumStringTPToEnum(_model
                                                      .choiceChipsValue) ==
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        valueOrDefault<
                                                                          ...
                                                                          dateTimeFormat(
                                                                            "dd/MM/yyyy  • HH:mm",
                                                                            m_s_framework_flutter_p5iajh_functions.dateNullFormate(functions.dataHoraJsonToDate(valueOrDefault<String>(
                                                                              ultimosAbastecimentoItem.datahora,
                                                                              '--',
                                                                            ))),
                                                                            locale:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            title:
                                                                                Text('TESTE'),
                                                                            content:
                                                                                Text('\$filter=(DATA EQ \'${dateTimeFormat(
                                                                              "yyyy-MM-dd",
                                                                              getCurrentTimestamp,
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                            text:
                                                                                valueOrDefault<String>(
                                                                              formatNumber(
                                                                                ultimosAbastecimentoItem.quantidade,
