              ...
              child: Column(
                ...
                children: [
                  ...
                  FlutterFlowChoiceChips(
                      ...
                      if (_model.ccFiltroValue == 'Cidade') {
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            ...
                            safeSetState(() => _model.actReturnCidade = value));
                    ...
                    rowSpacing: 8.0,
                    multiselect: false,
                    initialized: _model.ccFiltroValue != null,
                ...
                child: PagedListView<ApiPagingParams, dynamic>.separated(
                    ...
                    (nextPageMarker) => ClientesCall.call(
                      ...
                      pesquisa: functions.addFilterClientes(
                        ...
                        if (_model.ccFiltroValue == 'Pessoa Física') {
                          return 'F';
                        } else if (_model.ccFiltroValue == 'Pessoa Jurídica') {
                          return 'J';
                        } else {
                          return null;
                        }
                          ...
                          m_s_framework_flutter_p5iajh_functions
                              .allToUpperCase(_model.textController.text)),
                    ),
                  ),
                  ...
                  builderDelegate: PagedChildBuilderDelegate<dynamic>(
                    ...
                    noItemsFoundIndicatorBuilder: (_) => Center(
                      child: Container(
                        ...
                        child: m_s_framework_flutter_p5iajh
                          ...
                          sTitulo: 'Vazio',
                          sTexto:
                              'Lista de cliente vazia, verifique seus filtros ou tente novamente!',
                          bIsAction: false,
                          vSizeTitulo: 16.0,
                          vSizeTexto: 14.0,
                          corTitulo: FlutterFlowTheme.of(context).secondaryText,
                          corSubtitulo:
                    ...
                    itemBuilder: (context, _, listaClienteIndex) {
                      final listaClienteItem = _model.listViewPagingController!
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      height: 25.0,
                                      decoration: BoxDecoration(
                                        color: listaClienteItem.tppessoa == 'J'
                                            ? Color(0xFFE8F5E9)
                                            : Color(0x230064ED),
                                        borderRadius:
                                    ...
                                    Text(
                                      valueOrDefault<String>(
                                        'CÓDIGO: ${valueOrDefault<String>(
                                          listaClienteItem.idCodigo.toString(),
                                          '0',
                                        )}',
                                        '0',
                                      ),
